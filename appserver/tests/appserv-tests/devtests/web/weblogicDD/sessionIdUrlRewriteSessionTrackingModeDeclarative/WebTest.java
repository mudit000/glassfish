...
/*
 * Unit test for making sure that if URL has been configured as the only
 * session tracking mode in web.xml, there will be no session cookie
 * present in the response, and the redirect URL will get rewritten with the
 * session id appended to it.
 */
public class WebTest {
    ...
    private static final String TEST_NAME =
        "wl-session-id-url-rewrite-session-tracking-mode-declarative";
