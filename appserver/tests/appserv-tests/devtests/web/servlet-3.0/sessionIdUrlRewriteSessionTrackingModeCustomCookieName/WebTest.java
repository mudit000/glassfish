...
/*
 * Same as sessionIdUrlRewriteSessionTrackingMode, except that this test
 * also configures a custom session tracking cookie name, and expects this
 * name (instead of the default jsessionid) to be encoded in the redirect
 * URL.
 */
public class WebTest {
    ...
    private static final String TEST_NAME =
        "session-id-url-rewrite-session-tracking-mode-custom-cookie-name";
    ...
    private void invokeServlet() throws Exception {
        ...
        if (redirectLine.indexOf(";MYJSESSIONID=") == -1) {
            throw new Exception("Missing session id param in redirect URL");
        }
